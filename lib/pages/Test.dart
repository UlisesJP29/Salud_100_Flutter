...
class _InicioState extends State<Inicio> {
  ...
  var items3 = [
    {'index': 2, 'value': '2'},
    {'index': 4, 'value': '4'},
    {'index': 5, 'value': 'mayor a 5'},
  ];

  int dropdownvalue4 = 1;

  var items4 = [
    {'index': 1, 'value': 'Pequeña'},
    {'index': 2, 'value': 'Mediana'},
    {'index': 3, 'value': 'Grande'},
  ];
  ...
  var items7 = [
    {'index': 0, 'value': 'Mayor a 300,000'},
    {'index': 1, 'value': 'Entre 150,000 y 299,999'},
    {'index': 2, 'value': 'Entre 50,000 y 149,999'},
    {'index': 3, 'value': 'Menor de 49,999'},
  ];
    ...
    return Container(
      child: ListView(
        children: [
          ...
          ElevatedButton(onPressed: () async {}, child: Text('Enviar datos'))
        ],
      ),
    );
  }
